...
public class AddNewBuyRequestController implements Initializable {
    ...
    @FXML
    private TextField reasonForMoveTxt;

    @FXML
    private TextField bankDetailsTxt;

    @FXML
    private TextField landlordNoTxt;

    @FXML
    private ImageView searchCustomerId;
    ...
    void addOnAction(ActionEvent event) {
        ...
        String reasonToMove = reasonForMoveTxt.getText();
        String landLordNumber = landlordNoTxt.getText();
        ...
        try {
            CustomerDTO customer = requestBO.getCustomerDetails(customerId);
        ...
        if(!landLordNumber.isEmpty()){
            ...
            if(b1 && b2 && b3 && b4 && b5 && b7){
                ...
                RequestDTO requestDto = new RequestDTO(requestId,customerId,dateLabel.getText(),"Buy",houseType,Integer.parseInt(familyMembersCount),
                        Double.parseDouble(monthlyIncome),Double.parseDouble(annualIncome),bankDetails,reasonToMove,"N/A",
                        "N/A","N/A",smoking,criminalBackground,pets);
            ...
            if(b1 && b2 && b3 && b4 && b5){
                ...
                RequestDTO requestDto = new RequestDTO(requestId,customerId,dateLabel.getText(),"Buy",houseType,Integer.parseInt(familyMembersCount),
                        Double.parseDouble(monthlyIncome),Double.parseDouble(annualIncome),bankDetails,reasonToMove,"N/A",
                        "N/A",landLordNumber,smoking,criminalBackground,pets);
    ...
    @FXML
    void searchCustomerIdOnMouseClicked(MouseEvent event) {
    ...
    public void clean(){
        ...
        reasonForMoveTxt.setText("");
        landlordNoTxt.setText("");
